...
| **3b** — probes / PSK | `docs/KERNEL-MODULE-PLAN.md` §3.6-§3.7 + `KERNEL-MODULE-IMPLEMENTATION.md` §Phase 3b | 🚧 **In progress. Steps 1-4 done (`0d5c077`, `fa58e55`, `fc426a7`, `bc25de8`); full PING/PONG -> RTT EWMA pipeline live.** |
